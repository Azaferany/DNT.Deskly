...
namespace Microsoft.AspNetCore.Identity.EntityFrameworkCore
{
    ...
    public class IdentityUserContext<TUser> : IdentityUserContext<TUser, string> where TUser : IdentityUser
    {
        ...
        public IdentityUserContext(DbContextOptions options, IEnumerable<IHook> hooks) : base(options, hooks) { }
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        protected IdentityUserContext() : base(null, null) { }
    }
    ...
    public abstract class IdentityUserContext<TUser, TKey, TUserClaim, TUserLogin, TUserToken> : DbContextCore
        where TUser : IdentityUser<TKey>
        where TKey : IEquatable<TKey>
