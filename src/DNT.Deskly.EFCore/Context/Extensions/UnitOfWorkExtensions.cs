...
namespace DNT.Deskly.EFCore.Context.Extensions
{
    public static class UnitOfWorkExtensions
    {
        ...
        /// </summary>
        public static void UpdateGraph(this IUnitOfWork uow, IEnumerable<object> rootEntities)
        {
        ...
        /// This method is designed for use in disconnected scenarios.
        /// </summary>
        public static void UpdateGraph(this IUnitOfWork uow, object rootEntity)
        {
